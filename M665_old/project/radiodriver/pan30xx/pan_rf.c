...
{
  PAN_ConfigGpio(pan, MODULE_GPIO_RX, GPIO_MODE_OUTPUT);
  PAN_ConfigGpio(pan, MODULE_GPIO_TX, GPIO_MODE_OUTPUT);
...
{
    PAN_ConfigGpio(pan, MODULE_GPIO_TCXO, GPIO_MODE_OUTPUT);
...
void PAN_StartCad(uint8_t pan, uint8_t Threshold, uint8_t Chirps)
{
  ...
  PAN_ConfigGpio(pan, MODULE_GPIO_CAD_IRQ, GPIO_MODE_OUTPUT);
