...
bool sweepflag[3] = {false,false,false};
...
void ustimer_init(void)
{
	...
	timer_init(TIMER2, &timerx_init);
	timer_config_interrupt(TIMER2, TIMER_DIER_UIE, ENABLE);
	timer_generate_event(TIMER2, TIMER_EGR_UG, ENABLE);
