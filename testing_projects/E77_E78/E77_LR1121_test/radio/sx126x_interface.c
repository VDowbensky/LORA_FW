...
//		case 1:
//		//delay_us(20);
//		gpio_write(SX1262_RESET_PORT, SX1262_RESET_PIN,GPIO_LEVEL_LOW);
//		delay_us(50);
//		gpio_write(SX1262_RESET_PORT, SX1262_RESET_PIN,GPIO_LEVEL_HIGH);
//		delay_us(20);
...
{ 
  ...
  switch(sx)
  {
    ...
    while(attempts--)
    {
      if(!(PWR->SR2 & PWR_SR2_RFBUSYMS)) return true;
    }
    return false;
...
//		while(attempts--)
//    {
//			if(gpio_read(SX1262_BUSY_PORT,SX1262_BUSY_PIN) == GPIO_LEVEL_LOW) return true;
//    }
//    return false;	
...
//		case 1: //aux. SX1262
//		gpio_write(SX1262_NSS_PORT, SX1262_NSS_PIN,GPIO_LEVEL_LOW);
//		break;
...
//		case 1: //aux. SX1262
//		gpio_write(SX1262_NSS_PORT, SX1262_NSS_PIN,GPIO_LEVEL_HIGH);
//		break;
