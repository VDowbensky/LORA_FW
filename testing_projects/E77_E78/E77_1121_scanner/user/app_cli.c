...
CommandEntry_t commands[] =
  {
    ...
    COMMAND_ENTRY("SET_SCANPARAMS", "wwwwww", cli_setscanparams, "Set scanning parameters"),
		...
		COMMAND_ENTRY("SET_SCANS","ww",cli_setactivescans,""),
    ...
    COMMAND_ENTRY("GET_RSSI", "w", cli_getRSSI, ""),
		COMMAND_ENTRY("RSSI_CAL", "ww", cli_RSSIcal, ""), //calibrate RSSI (frequency, powerlevel)
    ...
    COMMAND_ENTRY("GET_TEMP", "w", cli_gettemp, ""),
		COMMAND_ENTRY("GET_VCC", "w", cli_getvcc, ""),
