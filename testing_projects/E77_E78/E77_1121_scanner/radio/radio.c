...
void radio_initconfigs(void)
{
  ...
  globalrfconfig.LBconfig.startfreq = 300000000;
	globalrfconfig.LBconfig.stopfreq =  600000000;
	globalrfconfig.LBconfig.scantimems = 10;
	globalrfconfig.LBconfig.freqstep = 100000;
	globalrfconfig.LBconfig.rssithreshold = -115;
  ...
  //LoRa
  globalrfconfig.LBconfig.sf = LORA_SF_11; //spreading factor
  globalrfconfig.LBconfig.bw = LORA_BW_250; //bandwidth
  ...
  globalrfconfig.LBconfig.lorasync = 0x24b4;
  ...
  globalrfconfig.HBconfig.startfreq = 600000000;
	globalrfconfig.HBconfig.stopfreq = 2700000000;
	globalrfconfig.HBconfig.scantimems = 10;
	globalrfconfig.HBconfig.freqstep = 1000000;
  ...
  //LoRa
  globalrfconfig.HBconfig.sf = LORA_SF_11; //spreading factor
  globalrfconfig.HBconfig.bw = LORA_BW_250; //bandwidth
  ...
  globalrfconfig.HBconfig.lorasync = 0x2b; //meshtastic
  ...
  //configs[2].addrcomp = SX126X_FSK_ADDR_FILT_DISABLED;
	globalrfconfig.HBconfig.addrcomp = FSK_ADDR_FILT_DISABLED; //for SX1280 only
...
void display_rssi(uint32_t radio,uint32_t freq,float rssi)
{
	...
	GUI_ShowString(0,16+16*radio,"                ",16,1);
